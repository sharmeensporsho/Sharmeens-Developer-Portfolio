var Filterizr = function(t) {
      ...
      , s = function(t, e, n, r, i) {
        if (void 0 !== e) {
            var o = new Error('Filterizr: expected type of option "' + t + '" to be "' + n + '", but its type is: "' + typeof e + '"')
              ...
              , a = !1
              , u = n.includes("array");
            if ((typeof e).match(n) ? s = !0 : !s && u && (a = Array.isArray(e)),
            !s && !u)
                throw o;
            if (!s && u && !a)
                throw o;
    ...
    function f(t) {
        ...
        if (l(t) && l(o))
            for (var s in o)
                l(o[s]) ? (t[s] || Object.assign(t, ((e = {})[s] = {},
                e)),
                f(t[s], o[s])) : Object.assign(t, ((n = {})[s] = o[s],
                n));
    ...
    var d = function(t) {
      ...
      , y = function() {
        ...
        return t.prototype.on = function(t, e) {
            ...
            r && n.length ? (this.eventDictionary[t] = e,
            Array.from(n).forEach(function(n) {
                n.addEventListener(t, e)
            })) : !r && n && (this.eventDictionary[t] = e,
            n.addEventListener(t, e))
        }
        ,
    ...
    function(t, e) {
        ...
        e.prototype.bindEvents = function() {
            ...
            this.eventReceiver.on("transitionend", function() {
                ...
                t.styles.setZIndex(-1e3)) : (t.node.classList.remove("filteredOut"),
        ...
        t.prototype.shuffle = function() {
            ...
            if (e.length > 1) {
                ...
                (r = d(e)).forEach(function(e, r) {
                    var i, o = n[r];
                    t.filterItems = Object.assign([], t.filterItems, ((i = {})[o] = e,
                    i))
                })
            }
        }
        ...
        t.prototype.shouldBeFiltered = function(t, e) {
            ...
            return Array.isArray(e) ? "or" === i ? !!(n = t,
            r = e,
    ...
    var V = function() {
      ...
      , rt = function() {
        function t(t, e) {
            ...
            this.node = (n = e.get().spinner,
            r = '<?xml version="1.0" encoding="UTF-8"?><svg stroke="' + n.fillColor + '" viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd" stroke-width="2"><circle cx="22" cy="22" r="1"><animate attributeName="r" begin="0s" calcMode="spline" dur="1.8s" keySplines="0.165, 0.84, 0.44, 1" keyTimes="0; 1" repeatCount="indefinite" values="1; 20"/><animate attributeName="stroke-opacity" begin="0s" calcMode="spline" dur="1.8s" keySplines="0.3, 0.61, 0.355, 1" keyTimes="0; 1" repeatCount="indefinite" values="1; 0"/></circle><circle cx="22" cy="22" r="1"><animate attributeName="r" begin="-0.9s" calcMode="spline" dur="1.8s" keySplines="0.165, 0.84, 0.44, 1" keyTimes="0; 1" repeatCount="indefinite" values="1; 20"/><animate attributeName="stroke-opacity" begin="-0.9s" calcMode="spline" dur="1.8s" keySplines="0.3, 0.61, 0.355, 1" keyTimes="0; 1" repeatCount="indefinite" values="1; 0"/></circle></g></svg>',
    ...
    var ut = function() {
      ...
      , ct = function() {
        ...
        t.prototype.fit = function(t) {
            var e, n, r, i = t.length, o = i > 0 ? t[0].h : 0;
            for (this.root.h = o,
            e = 0; e < i; e++)
                r = t[e],
        ...
        void 0 === (i = function(t) {
            return function(t, e) {
                ...
                function s(t, e, a) {
                    ...
                    setTimeout(this.check.bind(this))) : r.error("Bad element for imagesLoaded " + (u || t))
                }
...
, function(t, e) {
    function n(t, e, n, r) {
        var i, o = null == (i = r) || "number" == typeof i || "boolean" == typeof i ? r : n(r), s = e.get(o);
        return void 0 === s && (s = t.call(this, r),
        e.set(o, s)),
        s
    }
    function r(t, e, n) {
